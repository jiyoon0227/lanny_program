...
class ChapterScreen7 extends StatefulWidget {
  @override
  _ChapterScreen7State createState() => _ChapterScreen7State();
}

class _ChapterScreen7State extends State<ChapterScreen7> {
  // 하드코딩된 음식 챕터의 단어 리스트
