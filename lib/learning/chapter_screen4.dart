...
class ChapterScreen4 extends StatefulWidget {
  @override
  _ChapterScreen4State createState() => _ChapterScreen4State();
}

class _ChapterScreen4State extends State<ChapterScreen4> {
  // 하드코딩된 음식 챕터의 단어 리스트
