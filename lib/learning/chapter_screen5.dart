...
class ChapterScreen5 extends StatefulWidget {
  @override
  _ChapterScreen5State createState() => _ChapterScreen5State();
}

class _ChapterScreen5State extends State<ChapterScreen5> {
  // 하드코딩된 음식 챕터의 단어 리스트
